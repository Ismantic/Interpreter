...
def main():
    ...
    parser.add_argument("--model_path", default="./checkpoints/output_1.7b_cpo_v3_plus_7b_merged")
    parser.add_argument("--data_path", default="./data/grpo_data.jsonl")
    parser.add_argument("--output_dir", default="./checkpoints/output_1.7b_grpo")
