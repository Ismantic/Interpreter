...
Usage:
    python train_cpo.py \
        ...
        --output_dir ./checkpoints/output_1.7b_cpo_v3
"""
import os
import json
import math
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="./data/cpo_preference.jsonl")
    parser.add_argument("--output_dir", type=str, default="./checkpoints/output_1.7b_cpo_v3")
