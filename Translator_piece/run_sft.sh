#!/usr/bin/env bash
# SFT for Translator_piece.
#
# A/B contract with the Translator baseline (output_1.7b_base_v2):
...
DATA="$HERE/../Translator/alma_combined_sft_clean.jsonl"
...
if [ "$MODE" = "smoke" ]; then
    ...
    # Translator baseline used: --num_epochs 1, save every 1000 by default,
