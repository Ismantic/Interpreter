#!/usr/bin/env bash
# GRPO stage for Translator_piece.
# A/B with Translator/output_1.7b_grpo_full (started from CPO-merged): same data,
...
#
# Usage:
#   bash run_grpo.sh                # start from CPO-merged (matches Translator best lineage)
#   bash run_grpo.sh from_sft       # start from SFT (matches Translator/output_1.7b_grpo_from_sft)
set -euo pipefail
