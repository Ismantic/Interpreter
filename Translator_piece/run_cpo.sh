#!/usr/bin/env bash
# CPO stage (LoRA) for Translator_piece.
# A/B with Translator/output_1.7b_cpo_v3_plus_7b_merged: same data, same hyperparams,
...
DATA="$HERE/../Translator/cpo_v3_plus_7b.jsonl"
...
# Train LoRA. Effective batch = 16, same as Translator's best-practice run.
# Translator used bs=1 ga=16 + gradient_checkpointing; we use bs=4 ga=4 without
