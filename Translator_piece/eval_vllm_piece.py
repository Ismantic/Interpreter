...
Behavior-equivalent to ../Translator/eval_vllm.py — same WMT testsets, same prompt
...
from Translator/eval_vllm.py are:
...
# These templates are character-identical to Translator/eval_vllm.py
...
# Same COMET location Translator hardcodes
