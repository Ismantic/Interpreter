...
Tokenizer-only fork of ../Translator/train_cpo.py — the CPO loss math
...
Usage (matches Translator/train_cpo.py CLI):
    python train_cpo.py \\
        --model_path ./output_v18_sft \\
        --data_path ../Translator/cpo_v3_plus_7b.jsonl \\
...
# Reuse Translator_piece/train.py helpers (tokenizer wrapper + 5-file copy)
...
def compute_logps(model, input_ids, labels, pad_id):
    ...
    Identical to Translator/train_cpo.py:compute_logps."""
...
def main(args):
    ...
    # LoRA or full fine-tuning (Translator finding: full-param CPO collapses; use LoRA)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--full_finetune", action="store_true",
                        help="Full fine-tune instead of LoRA (NOT recommended — collapses model per Translator)")
